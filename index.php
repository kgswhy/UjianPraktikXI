          ...
          <?php while ($row = mysqli_fetch_array($makanan)) : ?>
            <tr class="text-center">
              ...
              <td>
                ...
                <a class="edit" title="Edit" name="edit" data-bs-toggle="modal" href="./makananedit.php?id=<?= $row["id"]; ?>"><i class="bi bi-pencil-square"></i></a>
                <a class="delete" title="Delete" name="delete" data-toggle="tooltip" href="./makanandel.php?hal=<?= $row["id"]; ?>" onclick="return confirm('Yakin Menghapus data Makanan tersebut?');"><i class="bi bi-trash3"></i></a>
              </td>
            </tr>
          <?php endwhile; ?>
        </tbody>
